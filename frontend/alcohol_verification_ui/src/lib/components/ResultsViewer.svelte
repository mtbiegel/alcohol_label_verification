...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
    <button
      ...
      class="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-blue-700 backdrop-blur-md hover:bg-blue-900 text-white font-semibold rounded-lg transition-colors shadow-md cursor-pointer"
    >
